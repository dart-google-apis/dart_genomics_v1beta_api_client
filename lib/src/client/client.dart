...
abstract class Client extends ClientBase {
  core.String basePath = "/genomics/v1beta/";
  ...
  BeaconsResource_ get beacons => new BeaconsResource_(this);
  CallsetsResource_ get callsets => new CallsetsResource_(this);
  DatasetsResource_ get datasets => new DatasetsResource_(this);
  ExperimentalResource_ get experimental => new ExperimentalResource_(this);
